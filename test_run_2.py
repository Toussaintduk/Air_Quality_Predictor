...
#st.image("""C:\Users\user\Desktop\Project\Urban_Air_pollution_challenge\alxafrica_logo.jpeg""")
st.image(r"C:\Users\user\Desktop\Project\Urban_Air_pollution_challenge\air quality.jpeg",use_column_width=True)
...
model = pickle.load(open('XGBoost_model_four_features.pkl', 'rb'))
